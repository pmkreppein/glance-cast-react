...
export default function Welcome() {
  return (
    <div className="box">
        ...
        <p>
        I intend to continue building this project out, so check back soon as updates are posted!  You can learn more about me <a href="https://pmkdev.com">here.</a>  Thanks for visiting!
        </p>
        <p>
